...
class RNNModel(gluon.Block):
    def __init__(self, mode, vocab_size, num_embed, num_hidden,
            num_layers, dropout=.5, tie_weights=False, **kwargs):
        ...
        with self.name_scope():
            ...
            if mode == 'rnn_relu':
                self.rnn = rnn.RNN(num_hidden, num_layers, activation =
                        'relu', dropout=dropout, input_size=num_embed)
            elif mode == 'rnn_tanh':
                ...
                raise ValueError('Invalid mode %s. rnn_relu|rnn_tanh|lstm|gru' % mode)
